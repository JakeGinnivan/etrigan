...
export const initialiseClient = (
    ...
    return new Promise<LaunchDarkly.LDClient>((resolve, reject) => {
        ...
        const timeout = setTimeout(() => {
            ...
            reject(
                new Error(
                    'Failed to initialise the launch darkly client, ' +
                        'see https://confluence.swmdigital.io/display/DPT/What+to+do+when+launch+darkly+is+down+when+The+West+starts',
                ),
            )
        }, 10000)
